   ...
   public partial class Add_tables_with_owned_entities : Migration
   {
      protected override void Up(MigrationBuilder migrationBuilder)
      {
                                      ...
                                      table => new
                                               {
                                                  ...
                                                  InlineEntity_StringColumn = table.Column<string>(nullable: true),
                                                  InlineEntity_IntColumn = table.Column<int>(nullable: true)
                                               },
         ...
         migrationBuilder.CreateTable(
                                      "SeparateEntities_Many",
                                      table => new
                                               {
                                                  TestEntityOwningManyEntitiesId = table.Column<Guid>(nullable: false),
                                      ...
                                      constraints: table =>
                                                   {
                                                      ...
                                                      table.ForeignKey("FK_SeparateEntities_Many_TestEntitiesOwningManyEntities_TestEntityOwningManyEntitiesId",
         ...
         migrationBuilder.CreateTable("SeparateEntities_One",
                                      table => new
                                               {
                                                  TestEntityOwningOneSeparateEntityId = table.Column<Guid>(nullable: false),
                                                  StringColumn = table.Column<string>(nullable: true),
                                                  IntColumn = table.Column<int>(nullable: false)
                                               },
                                      constraints: table =>
                                                   {
                                                      ...
                                                      table.ForeignKey("FK_SeparateEntities_One_TestEntitiesOwningOneSeparateEntity_TestEntityOwningOneSeparateEntityId",
